...
${BASE_DIR}/internals/install/build_curl.sh
${BASE_DIR}/internals/install/get_miniconda.sh # This script depends on curl

#source ${BASE_DIR}/internals/install/curl_paths.sh # this is actually redundant, since already sourced in get_miniconda
